"use strict";
{
        ...
        "properties";
    {
        "info";
        {
                ...
                "properties";
            {
                ...
                "dictionary-lang";
                {
                    ...
                    "string",
                        "markdownDescription";
                    "This special property is used by dictionaries. Add it only if you're using the 'dictionary' attribute.\nExample: dictionary-lang: \"en\"";
                }
            }
        }
        "items";
        ...
        "worlds_populators";
        {
            ...
            "object",
                "markdownDescription";
            "(**OLD NAME**, use the new `blocks_populators` instead.)",
                "kind";
            5,
                "detail";
            "(collection)",
        ...
        "dictionary";
        {
                ...
                "additionalProperties";
            {
                ...
                "string",
                    "markdownDescription";
                "You can then use this property name as any item name or /ia category, it will be replaced with this value.";
            }
            "properties";
            {
        ...
        "equipments";
        {
            ...
            "object",
                "markdownDescription";
            "Create custom equipments.",
                "additionalProperties";
            {
                "type";
                "object",
                    "$ref";
                "#/$defs/equipments_entry";
            }
            "properties";
            {
                "my_equipment";
    ...
    "$defs";
    {
        "attribute_modifiers";
        {
                ...
                "properties";
            {
                ...
                {
                    "$ref";
                    "#/$defs/attribute_modifier", "deprecated";
                    true;
                }
                "attackSpeed";
                {
        ...
        "attribute_modifier";
        {
            ...
            "attribute_modifier",
                "markdownDescription";
            `You can directly set a value or set \`value\` and \`operation\`.\n## Examples:
\`\`\`
attribute_modifiers:
  mainhand:
    attackDamage: 2
...
`,
        ...
        "bukkit_materials_and_customitems";
        {
            ...
            "bukkit_materials_and_customitems",
                "title";
            "Vanilla / ItemsAdder custom item",
                "markdownDescription";
            "Examples: **STONE**, **itemsadder:ruby**, **ruby**",
                "type";
            "string",
                "anyOf";
            [
        ...
        "vanilla_and_custom_blocks";
        {
            ...
            "vanilla_and_custom_blocks",
                "title";
            "Vanilla / ItemsAdder custom blocks",
                "markdownDescription";
            "Examples: **STONE**, **itemsadder:ruby_block**, **crying_obsidian**",
                "type";
            "string",
                "anyOf";
            [
        ...
        "custom_potion_effect";
        {
                ...
                "properties";
            {
                ...
                {
                    "$ref";
                    "#/$defs/bukkit_potion_effect_type";
                }
                "amplifier";
                {
                    "$ref";
                    "#/$defs/potion_amplifier";
                }
                "duration";
                {
                    "$ref";
        ...
        "vanilla_and_custom_sound";
        {
            ...
            "string",
                "markdownDescription";
            "Vanilla and custom sounds",
                "anyOf";
            [{ "$ref": "#/$defs/vanilla_sound" }, { "type": "string" }];
        }
                ...
                "properties";
            {
                "block";
                {
                        ...
                        "properties";
                    {
                        "placed_model";
                        {
                                ...
                                "properties";
                            {
                                ...
                                "shift_up";
                                {
                                    ...
                                    "boolean",
                                        "markdownDescription";
                                    "This allows to make some blocks placed one block up. This is useful for REAL_WIRE blocks to create tall plants.";
                                }
                                "placeable_on_other_real_wire";
                                {
                                    ...
                                    "boolean",
                                        "markdownDescription";
                                    "This allows to make this REAL_WIRE block placeable on top of another REAL_WIRE block.";
                                }
                                "placeable_on_water";
                                {
                                    "type";
                                    "boolean",
                                        "markdownDescription";
                                    "This allows to make this block placeable directly on water surface.";
                                }
                                "placeable_on_lava";
                                {
                                    "type";
                                    "boolean",
                                        "markdownDescription";
                                    "This allows to make this block placeable directly on lava surface.";
                                }
                                "custom_variants";
                                {
                                    "type";
                        ...
                        {
                            "markdownDescription";
                            "Mining hardness", "type";
                            "number";
                        }
                        "blast_resistance";
                        {
                            "markdownDescription";
                            "Explosion resistance. It is hardness*3 by default if you don't set blast_resistance.",
                                "type";
                            "number";
                        }
                        "no_explosion";
                        ...
                        "cancel_drop";
                        {
                            ...
                            false,
                                "markdownDescription";
                            "Default is `false`. If `true` the custom block won't be dropped when a player mines it";
                        }
                        "light_level";
                        {
                            "type";
                            "integer",
                                "markdownDescription";
                            "Set this to make the block emit light.",
                                "minimum";
                            1,
                                "maximum";
                            15;
                        ...
                        "break_tools_whitelist";
                        {
                            ...
                            "array",
                                "markdownDescription";
                            "Whitelist of tools that cannot break this block",
                                "items";
                            {
                                "anyOf";
                                [
                        ...
                        "events_tools_whitelist";
                        {
                            ...
                            "array",
                                "markdownDescription";
                            "Whitelist of tools that can run events on this block (placed_block.interact)",
                                "items";
                            {
                                "anyOf";
                                [
                        ...
                        "events_tools_blacklist";
                        {
                            ...
                            "array",
                                "markdownDescription";
                            "Blacklist of tools that can't run events on this block (placed_block.interact)",
                                "items";
                            {
                                "anyOf";
                                [
                ...
                "leather_horse_armor";
                {
                    "properties";
                    {
                        ...
                        {
                            "markdownDescription";
                            "Can be recolored by putting it into the crafting table with a dye item (vanilla behaviour for dyeable items).",
                                "type";
                            "boolean",
                                "default";
                            false,
                ...
                "properties";
            {
                ...
                "mmoitem";
                {
                        ...
                        "properties";
                    {
                        ...
                        {
                            "markdownDescription";
                            "MMOITEM Type (check MMOItems docs)",
                                "type";
                            "string";
                        }
                        "id";
                        {
                            "markdownDescription";
                            "MMOITEM id (check MMOItems docs)",
                                "type";
                            "string";
                        }
                        ...
                        {
                            "markdownDescription";
                            "Use the display name of MMOitems item instead of the one from ItemsAdder. Default `false`.",
                                "type";
                            "string";
                        }
                    }
                ...
                "resource";
                {
                        ...
                        "properties";
                    {
                        ...
                        "model_id";
                        {
                            ...
                            "integer",
                                "markdownDescription";
                            "(**OLD NAME**, use `custom_model_data` instead). If you want to force the usage of a defined `custom_model_data` (CustomModelData) you can set this value.\nhttps://itemsadder.devs.beer/plugin-usage/adding-content/item-properties/resource#manually-specify-custom_model_data",
                                "doNotSuggest";
                            true;
                        }
                    }
                    ...
                    "then";
                    {
                        "properties";
                        {
                            ...
                            "texture";
                            {
                                ...
                                "Set `generate: true` to use this!",
                                    "markdownDescription";
                                "Specifies the texture layer to be used to generate the model.\nIf you are creating a block you can set a texture for each face of the block in this order:\n- block/block_down.png\n- block/block_east.png\n- block/block_north.png\n- block/block_south.png\n- block/block_up.png\n- block/block_west.png",
                                    "defaultSnippets";
                                [
                                    { "body": "item/$0.png" },
                                    { "body": "block/$0.png" }
                    ...
                    "else";
                    {
                        "properties";
                        {
                            "model_path";
                            {
                                ...
                                "string",
                                    "title";
                                "Set `generate: false` to use this!",
                                    "defaultSnippets";
                                [{ "body": "item/$0" }, { "body": "block/$0" }];
                            }
                        }
                        "required";
                        ["model_path"];
                ...
                "durability";
                {
                        ...
                        "properties";
                    {
                        ...
                        "disappear_when_broken";
                        {
                            ...
                            "boolean",
                                "markdownDescription";
                            "If the item should disappear when broken";
                        }
                        "unbreakable";
                        {
                            "type";
                        ...
                        "repair_cost";
                        {
                            ...
                            "integer",
                                "markdownDescription";
                            "Initial cost to repair the item in an anvil";
                        }
                        "usages";
                        {
                            "type";
                            "integer",
                                "markdownDescription";
                            "Usages of the item before it disappears (you must handle usages using an event and action (decrement_usages) https://itemsadder.devs.beer/plugin-usage/adding-content/item-properties/events/actions";
                        }
                    }
                }
                "item_flags";
                ...
                "consumable";
                {
                        ...
                        "properties";
                    {
                        "nutrition";
                        {
                            ...
                            "integer",
                                "markdownDescription";
                            "Nutrition value of the food item. Not mandatory.";
                        }
                        "saturation";
                        {
                            "type";
                            "number",
                                "markdownDescription";
                            "Saturation value of the food item. Not mandatory.";
                        }
                        "can_always_eat";
                        {
                            "type";
                            "boolean",
                                "markdownDescription";
                            "If the player can eat the food item even if they are not hungry. Not mandatory.";
                        }
                        "consume_seconds";
                        {
                            "type";
                            "integer",
                                "markdownDescription";
                            "How many seconds it takes to consume the food item.";
                        }
                        "sound";
                        {
                            "type";
                            "string",
                                "markdownDescription";
                            "Sound of the food item when eaten. Available on `1.21.2+` clients only!",
                                "$ref";
                            "#/$defs/vanilla_and_custom_sound";
                        }
                        "particles";
                        {
                            ...
                            "boolean",
                                "markdownDescription";
                            "If the particles of the food item should be shown. Available on `1.21.2+` clients only!";
                        }
                        "animation";
                        {
                            "type";
                            "string",
                                "markdownDescription";
                            "Animation of the food item when eaten. Available on `1.21.2+` clients only!",
                                "enum";
                        ...
                        "effects";
                        {
                            ...
                            "object",
                                "markdownDescription";
                            "Effects of the consumable item when consumed",
                                "patternProperties";
                            {
                                "apply_status_effects.*";
                                {
                                    "$ref";
                                    "#/$defs/consumable_effect_apply_status_effects";
                                }
                                "remove_status_effects.*";
                                {
                                    "$ref";
                                    "#/$defs/consumable_effect_remove_status_effects";
                                }
                                "play_sound.*";
                                {
                                    "$ref";
                                    "#/$defs/consumable_effect_play_sound";
                                }
                                "clear_all_status_effects.*";
                                {
                                    "$ref";
                                    "#/$defs/consumable_effect_clear_all_status_effects";
                                }
                                "teleport_randomly.*";
                                {
                                    "$ref";
                                    "#/$defs/consumable_effect_teleport_randomly";
                                }
                            }
                            "properties";
                            {
                ...
                "food";
                {
                    ...
                    "object",
                        "markdownDescription";
                    "OLD NAME, use `consumable` instead!",
                        "doNotSuggest";
                    true;
                }
                "equipment";
                {
                        ...
                        "properties";
                    {
                        "id";
                        {
                            ...
                            "string",
                                "markdownDescription";
                            "Equipment ID. Must be a valid ID of an equipment created under the `equipments` section.";
                        }
                        "slot";
                        {
                            "type";
                            "string",
                                "markdownDescription";
                            "Slot in which this item can be equipped. This is automatically set if the item is a vanilla armor piece.\nExample: `material: IRON_HELMET` will automatically set `slot: HEAD`.",
                                "enum";
                            [
                                "HEAD",
                                "CHEST",
                        ...
                        "camera_overlay_id";
                        {
                            ...
                            "string",
                                "markdownDescription";
                            "(optional): namespaced ID of the overlay texture to use when equipped. Example: `minecraft:misc/pumpkinblur` (which addresses `assets/minecraft/textures/misc/pumpkinblur.png`).";
                        }
                        "sound";
                        {
                            "type";
                            "string",
                                "markdownDescription";
                            "(optional): sound to play when equipped. Example: `minecraft:item.armor.equip_iron`.";
                        }
                        "dispensable";
                        {
                            "type";
                            "boolean",
                                "markdownDescription";
                            "(default: `true`), whether the item can be equipped by using a Dispenser.";
                        }
                        "swappable";
                        {
                            "type";
                            "boolean",
                                "markdownDescription";
                            "boolean (default: `true`), whether the item can be equipped into the relevant slot by right-clicking.";
                        }
                        "allowed_entities";
                        {
                            "type";
                        ...
                        "damage_on_hurt";
                        {
                            ...
                            "boolean",
                                "markdownDescription";
                            "(default: `true`), whether this item will be damaged when the wearing entity is damaged.";
                        }
                        "slot_attribute_modifiers";
                        {
                            "markdownDescription";
                            "(optional) Attribute modifiers to be applied when equipped on the previously specified `slot`.",
                                "$ref";
                            "#/$defs/attribute_modifiers";
                        }
                        "glider";
                        {
                            ...
                            "boolean",
                                "markdownDescription";
                            "(default: `false`), whether this item can be used to glide (without the ELytra).";
                        }
                    }
                }
                "tooltip_style";
                ...
                "fire_resistant";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "If the item is fire resistant, like nethgerite items.";
                }
                "hide_tooltip";
                {
                    "type";
                    "boolean",
                        "markdownDescription";
                    "If the item tooltip should be hidden.";
                }
                "glint";
                {
                    "type";
                ...
                "events_cooldown";
                {
                    ...
                    "integer",
                        "markdownDescription";
                    "(**OLD NAME** OF THE property `events_settings.cooldown.ticks`.\n\nUse it instead.)",
                        "doNotSuggest";
                    true;
                }
                "events_settings";
                        ...
                        "cooldown";
                        {
                                ...
                                "properties";
                            {
                                "ticks";
                                {
                                    ...
                                    "integer",
                                        "markdownDescription";
                                    "Cooldown in ticks before user can activate events of this item",
                                        "defaultSnippets";
                                    [
                                ...
                                "indicator";
                                {
                                    ...
                                    "string",
                                        "markdownDescription";
                                    "Type of cooldown indicator, for now there is only HIDDEN and TITLE",
                                        "enum";
                                    [
                                        "HIDDEN",
                                        "VANILLA",
                            ...
                            "then";
                            {
                                "properties";
                                {
                                    "bossbar";
                                    {
                                        ...
                                        "object",
                                            "markdownDescription";
                                        "Properties for the bossbar indicator.",
                                            "properties";
                                        {
                                            "color";
                                            {
                                ...
                                "then";
                                {
                                    "properties";
                                    {
                                        "custom_hud";
                                        {
                                            ...
                                            "string",
                                                "markdownDescription";
                                            "Namespaced ID if the custom hud used for this cooldown. Default value `_iainternal:small_cooldown_bar`.",
                                            ;
                                        }
                                    }
                                }
                ...
                "permission";
                {
                    ...
                    "string",
                        "markdownDescription";
                    "**OLD NAME** OF THE property `permission_suffix`.\n\nUse `permission_suffix` instead.",
                        "doNotSuggest";
                    true;
                }
            }
        ...
        "ia_categories";
        {
                ...
                "properties";
            {
                ...
                {
                    "markdownDescription";
                    "Display name of the category, inside the category view itself. Value of 'name' attribute will be used if not specified.",
                        "type";
                    "string";
                }
                "permission";
                ...
                "skip_if_already";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "Skip this category if ItemsAdder already registered one with the same name from another .yml file";
                }
                "icon";
                {
                    "markdownDescription";
                    "Icon of this category. Can be a custom item or a vanilla material",
                        "$ref";
                    "#/$defs/bukkit_materials_and_customitems";
                }
                "font_image";
                {
                    "type";
                    "object",
                        "markdownDescription";
                    "Font image to be used as background of the category. Usually used for custom categories.",
                        "properties";
                    {
                        "name";
                        {
                            ...
                            "string",
                                "markdownDescription";
                            "Namespaced ID of the font_image to be used as background. (example: 'mcguis:blank_menu')";
                        }
                        "x_position_pixels";
                        {
                            "type";
                            "integer",
                                "markdownDescription";
                            "Shift the font_image of some pixels on the X axis. Usually set to -16";
                        }
                    }
                }
                "title_position_pixels";
                {
                    ...
                    "integer",
                        "markdownDescription";
                    "Shift the title text of some pixels on the X axis. Usually set to 0";
                }
                "show_all_items";
                {
                    "type";
                    "boolean",
                        "markdownDescription";
                    "Show all items in this category (you can exclude some items using the hide_items attribute)";
                }
                "items";
                {
                    "type";
                ...
                "hide_items";
                {
                    ...
                    "array",
                        "markdownDescription";
                    "List of items to be hidden from this category (useful if you're using show_all_items property)",
                        "items";
                    {
                        "$ref";
                        "#/$defs/bukkit_materials_and_customitems";
                ...
                "properties";
            {
                ...
                "entries";
                {
                        ...
                        "additionalProperties";
                    {
                        ...
                        "string",
                            "markdownDescription";
                        "Language attribute to replace, example: menu.shareToLan",
                            "default";
                        "menu.shareToLan";
                    }
                    "properties";
                    {
                        "menu.shareToLan";
                        {
                            ...
                            "string",
                                "markdownDescription";
                            "Example language attribute to replace",
                                "default";
                            "Open to LAN";
                        }
                    }
        ...
        "loots_result";
        {
            ...
            "object",
                "required";
            ["item", "min_amount", "max_amount", "chance"],
                "properties";
            {
                "item";
                {
        ...
        "recipe.craft";
        {
                ...
                "properties";
            {
                ...
                {
                    "markdownDescription";
                    "Allow the player to place the ingredients anywhere in the crafting table.",
                        "type";
                    "boolean";
                }
                "ingredients";
        ...
        "recipe.cooking";
        {
                ...
                "properties";
            {
                ...
                "machines";
                {
                    ...
                    "array",
                        "markdownDescription";
                    "List of the machines that will have this recipe available",
                        "items";
                    {
                        "type";
                        "string",
        ...
        "recipe.smithing";
        {
                ...
                "properties";
            {
                ...
                "base";
                {
                    ...
                    "string",
                        "markdownDescription";
                    "The base item (can be a custom item or vanilla material) on the first slot.",
                        "$ref";
                    "#/$defs/bukkit_materials_and_customitems";
                }
                "addition";
                {
                    ...
                    "string",
                        "markdownDescription";
                    "The mineral item (can be a custom item or vanilla material) on the second slot.",
                        "$ref";
                    "#/$defs/bukkit_materials_and_customitems";
                }
                "result";
                        ...
                        "properties";
                    {
                        ...
                        "move_attributes";
                        {
                                ...
                                "properties";
                            {
                                ...
                                {
                                    "markdownDescription";
                                    "Expert users: Move the `custom_model_data` from the `base` to the `result`. Use this property only if you know what you are doing. Default: `false`",
                                        "type";
                                    "boolean";
                                }
                                "material";
                                {
                                    "markdownDescription";
                                    "Expert users: Move the material from the `base` to the `result`. Use this property only if you know what you are doing. Default: `false`",
                                        "type";
                                    "boolean";
                                }
                                "other_nbt";
                                {
                                    "markdownDescription";
                                    "Expert users: Move custom NBT data (`minecraft:custom_data`) from the `base` to the `result`. Use this property only if you know what you are doing. Default: `false`",
                                        "type";
                                    "boolean";
                                }
                            }
        ...
        "loot.block";
        {
                ...
                "properties";
            {
                ...
                {
                    "markdownDescription";
                    "**Accepts only blocks, don't set items as type!**",
                        "$ref";
                    "#/$defs/vanilla_and_custom_blocks";
                }
                "nbt";
        ...
        "metadata_matcher";
        {
                ...
                "properties";
            {
                ...
                "type";
                {
                    ...
                    "string",
                        "enum";
                    ["string", "int", "float", "double", "byte", "short"];
                }
            }
        }
        "loot.fishing";
        ...
        "block_populator";
        {
                ...
                "properties";
            {
                ...
                "worlds";
                {
                    ...
                    "array",
                        "markdownDescription";
                    "Worlds list in which you want to spawn ores",
                        "items";
                    {
                        "anyOf";
                        [
                ...
                {
                    "markdownDescription";
                    "Blocks that can be replaced when the ore vein is spawned",
                        "type";
                    "array",
                        "items";
                    {
        ...
        "surface_decorators";
        {
                ...
                "properties";
            {
                ...
                "worlds";
                {
                    ...
                    "array",
                        "markdownDescription";
                    "Worlds list in which you want to spawn blocks",
                        "items";
                    {
                        "anyOf";
                        [
                ...
                {
                    "markdownDescription";
                    "The custom block will be spawned only if one of these material is available on the surface of the chunk.",
                        "type";
                    "array",
                        "items";
                    {
        ...
        "cave_decorators";
        {
                ...
                "properties";
            {
                ...
                {
                    "markdownDescription";
                    "The custom block will be spawned only if one of these material is available in the caves.",
                        "type";
                    "array",
                        "items";
                    {
        ...
        "trees_populators";
        {
                ...
                "properties";
            {
                ...
                {
                    "markdownDescription";
                    "The custom tree will be spawned only if one of these material is available on the surface of the chunk.",
                        "type";
                    "array",
                        "items";
                    {
        ...
        "behaviours";
        {
                ...
                "properties";
            {
                "hat";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "Tells ItemsAdder that this item is a hat.\nYou will be able to wear it on your head.";
                }
                "keep_on_death";
                {
                    "type";
                    "boolean",
                        "markdownDescription";
                    "This allows you to let the players keep the item when they die.";
                }
                "music_disc";
                {
                    "$ref";
                    "#/$defs/behaviour.music_disc";
                }
                "gun";
                {
                    "$ref";
                ...
                {
                    "$ref";
                    "#/$defs/behaviour.furniture_sit";
                }
                "furniture";
                {
                    "$ref";
                    "#/$defs/behaviour.furniture";
                }
                "block_trade_machine";
                {
                    "$ref";
                    "#/$defs/behaviour.trade_machine";
                }
                ...
                "liquid_analyzer";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "Tells ItemsAdder that this item is a liquid analyzer.\nYou will be able to check which custom liquid you're looking at.";
                }
                "liquid_bucket";
                {
                    "$ref";
                    "#/$defs/behaviour.liquid_bucket";
                }
                "fuel";
                {
                    "$ref";
                ...
                "sapling";
                {
                        ...
                        "properties";
                    {
                        "tree_populator";
                        {
                            ...
                            "string",
                                "markdownDescription";
                            "The tree_populator to spawn on right click.";
                        }
                    }
                }
            }
                ...
                "song";
                {
                        ...
                        "properties";
                    {
                        ...
                        "markdownDescription";
                        {
                            ...
                            "string",
                                "markdownDescription";
                            "markdownDescription of the song. This will be shown in Actionbar when you put the disc inside a jukebox";
                        }
                    }
                }
            }
        ...
        "behaviour.gun";
        {
                ...
                "properties";
            {
                ...
                {
                    "markdownDescription";
                    "Which item will be used as projectile for the gun",
                        "$ref";
                    "#/$defs/bukkit_materials_and_customitems";
                }
            }
        ...
        "behaviour.furniture_sit";
        {
                ...
                "properties";
            {
                ...
                "sit_all_solid_blocks";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "Default: true. Enable if you want the player to be able to sit on every BARRIER block of the furniture (for multi-seats chairs).\n\nThis works only on solid furnitures!";
                }
            }
        }
        "behaviour.furniture";
        {
                ...
                "properties";
            {
                ...
                "entity";
                {
                    ...
                    "string",
                        "markdownDescription";
                    "Type of entity to use to create this furniture.",
                        "enum";
                    ["item_display", "armor_stand", "item_frame", "glow_item_frame"];
                }
                "gravity";
                {
                    "type";
                ...
                "small";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "If the furniture is small or big, be sure to base your 3D model on this setting.\nResize your model using Blockbench accordingly";
                }
                "fixed_rotation";
                {
                    "type";
                    "boolean",
                        "markdownDescription";
                    "If the furniture has fixed rotation (to place it precisely, for example use it for a wall picture)";
                }
                "light_level";
                {
                    "type";
                    "integer",
                        "markdownDescription";
                    "Set this to make the furniture emit light.",
                        "minimum";
                    1,
                        "maximum";
                    15;
                ...
                "shift_interact_rotate";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "Default is `true`. If `true` the custom `item_frame` furniture can be rotated on shift interaction (right-click).";
                }
                "solid";
                {
                    "type";
                    "boolean",
                        "markdownDescription";
                    "If the furniture is solid. ItemsAdder will add hitbox made of BARRIER blocks to simulate furniture collisions.\nYou can customize hitbox size using 'hitbox' property.";
                }
                "hitbox";
                {
                    "type";
                ...
                "opposite_direction";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "Makes the model rotate 180 degrees automatically when placed";
                }
                "permission_suffix";
                {
                    "properties";
                ...
                "cancel_drop";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "This option allows you to avoid furniture from being dropped when broken by players.";
                }
                "display_transformation";
                {
                    ...
                    "object",
                        "markdownDescription";
                    "`item_display` property that allows to resize, move or rotate the model freely.",
                        "properties";
                    {
                        "adjust_legacy_model";
                        {
                            ...
                            "string",
                                "markdownDescription";
                            "Fixes models created for `item_frame` or `armor_stand` to work correctly with `item_display` without having to adjust all models manually.",
                                "enum";
                            [
                                "armor_stand",
                                "small_armor_stand",
                        ...
                        {
                            "$ref";
                            "#/$defs/item_display.translation.rotation";
                        }
                        "left_rotation";
                        {
                            "$ref";
        ...
        "item_display.translation.rotation";
        {
            ...
            "object",
                "markdownDescription";
            "Rotate the model. Use `axis_angle` or `quaternion`, not both.",
                "oneOf";
            [
                {
                    "properties": {
        ...
        "behaviour.trade_machine";
        {
                ...
                "properties";
            {
                ...
                "gui_texture";
                {
                    ...
                    "object",
                        "markdownDescription";
                    "Reskin your trading GUI with a custom texture. Keep in mind that the title will be removed if you reskin this GUI.",
                        "left";
                    {
                        "type";
                        "string",
                            "markdownDescription";
                        "This is the left texture of the trading GUI. Use a font_image name here.";
                    }
                    "right";
                    {
                        "type";
                        "string",
                            "markdownDescription";
                        "This is the right texture of the trading GUI. Use a font_image name here.";
                    }
                }
                "trades_list";
                {
        ...
        "behaviour.vehicle";
        {
                ...
                "properties";
            {
                ...
                "fixed_rotation";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "If the vehicle has fixed rotation (to place it precisely)";
                }
                "small";
                {
                    "type";
                    "boolean",
                        "markdownDescription";
                    "If the vehicle is small or big, be sure to base your 3D model on this setting.\nResize your model using Blockbench accordingly";
                }
                "step_height";
                {
                    "type";
                ...
                "fuel";
                {
                        ...
                        "properties";
                    {
                        "start";
                        {
                            ...
                            "number",
                                "markdownDescription";
                            "Start fuel value when you craft/get this vehicle";
                        }
                        "max";
                        {
                            "type";
                            "number",
                                "markdownDescription";
                            "Max fuel value this vehicle can reach";
                        }
                        "items";
                        {
                            "markdownDescription";
        ...
        "behaviour.mob";
        {
                ...
                "properties";
            {
                ...
                "animation";
                {
                        ...
                        "properties";
                    {
                        "attack";
                        {
                            ...
                            "string",
                                "markdownDescription";
                            "Item used to represent the attack animation of this mob";
                        }
                        "walk";
                        {
                            "type";
                            "string",
                                "markdownDescription";
                            "Item used to represent the walk animation of this mob";
                        }
                    }
                }
                "invisible";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "If the vanilla entity is invisible. **true** by default";
                }
                "boss_bar";
                {
                    "type";
                ...
                "baby";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "If the vanilla entity is a baby. This is useful for ZOMBIE type to have a smaller entity";
                }
                "hit_color";
                {
                    "type";
                ...
                "clear_inventory";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "Clear inventory on spawn (because sometimes ZOMBIES and other mobs spawn with swords/armors)";
                }
                "lock_head_rotation";
                {
                    "properties";
                ...
                "y_offset";
                {
                    ...
                    "number",
                        "markdownDescription";
                    "This tells ItemsAdder to shift the mob on the Y axis. Useful for SQUIDs and other mobs.";
                }
                "upside_down";
                {
                    "markdownDescription";
        ...
        "replace_mobs_spawn";
        {
                ...
                "properties";
            {
                ...
                "max_sky_light";
                {
                    ...
                    "integer",
                        "markdownDescription";
                    "Max light that triggers this action. 15 is outside",
                        "minimum";
                    -1,
                        "maximum";
                    16;
        ...
        "behaviour.fuel";
        {
                ...
                "properties";
            {
                ...
                "burn_ticks";
                {
                    ...
                    "integer",
                        "markdownDescription";
                    "Duration of the fuel in ticks (20 ticks = 1 second). Vanilla COAL burns for 1600 ticks";
                }
                "machines";
                {
                    "type";
                    "array",
                        "markdownDescription";
                    "List of the machines that will accept this fuel",
                        "items";
                    {
                        "type";
                        "string",
                ...
                "properties";
            {
                ...
                "placed_block";
                {
                        ...
                        "properties";
                    {
                        ...
                        {
                            "markdownDescription";
                            "Triggered when you interact this placed item. **Must be a custom block**",
                                "$ref";
                            "#/$defs/actions";
                        }
                        "break";
                        {
                            "markdownDescription";
                            "Triggered when you break this placed item. **Must be a custom block**",
                                "$ref";
                            "#/$defs/actions";
                        }
                    }
                ...
                "placed_furniture";
                {
                        ...
                        "properties";
                    {
                        ...
                        {
                            "markdownDescription";
                            "Triggered when you interact with furniture.",
                                "$ref";
                            "#/$defs/actions";
                        }
                        "break";
                        {
                            "markdownDescription";
                            "Triggered when you break a furniture.",
                                "$ref";
                            "#/$defs/actions";
                        }
                    }
                ...
                "holding_item";
                {
                        ...
                        "properties";
                    {
                        ...
                        {
                            "markdownDescription";
                            "Triggered while the player is holding this item in the mainhand and gets attacked by an entity.",
                                "$ref";
                            "#/$defs/actions";
                        }
                    }
                ...
                "holding_item_offhand";
                {
                        ...
                        "properties";
                    {
                        ...
                        {
                            "markdownDescription";
                            "Triggered while the player is holding this item in the offhand and gets attacked by an entity.",
                                "$ref";
                            "#/$defs/actions";
                        }
                    }
                ...
                "equipped_armor_item";
                {
                        ...
                        "properties";
                    {
                        ...
                        {
                            "markdownDescription";
                            "Triggered while the player is wearing this armor piece and gets attacked by an entity.",
                                "$ref";
                            "#/$defs/actions";
                        }
                    }
                ...
                "item_frame";
                {
                        ...
                        "properties";
                    {
                        ...
                        {
                            "markdownDescription";
                            "Triggered when you put this item on an item_frame.",
                                "$ref";
                            "#/$defs/actions";
                        }
                        "remove_item";
                        {
                            "markdownDescription";
                            "Triggered when you remove this item from an item_frame.",
                                "$ref";
                            "#/$defs/actions";
                        }
                    }
                ...
                "armor_stand";
                {
                        ...
                        "properties";
                    {
                        ...
                        {
                            "markdownDescription";
                            "Triggered when you put this item on an armor_stand.",
                                "$ref";
                            "#/$defs/actions";
                        }
                        "remove_item";
                        {
                            "markdownDescription";
                            "Triggered when you remove this item from an armor_stand.",
                                "$ref";
                            "#/$defs/actions";
                        }
                    }
        ...
        "actions";
        {
                ...
                "patternProperties";
            {
                ...
                {
                    "$ref";
                    "#/$defs/decrement_increment_durability";
                }
                "^decrement_durability(.*)$";
                {
                    "$ref";
                ...
                {
                    "$ref";
                    "#/$defs/decrement_usages";
                }
                "^increment_amount(.*)$";
                {
                    "$ref";
                    "#/$defs/increment_amount";
                }
                "^decrement_amount(.*)$";
                {
                    "$ref";
                    "#/$defs/decrement_amount";
                }
                "^drop_exp(.*)$";
                {
                    "$ref";
                ...
                {
                    "$ref";
                    "#/$defs/replace_near_blocks";
                }
                "^glow_near_blocks(.*)$";
                {
                    "$ref";
                    "#/$defs/glow_near_blocks";
                }
                "^replace_block(.*)$";
                {
                    "$ref";
                ...
                {
                    "$ref";
                    "#/$defs/damage_near_entities";
                }
                "^damage_entity_in_sight(.*)$";
                {
                    "$ref";
                    "#/$defs/damage_entity_in_sight";
                }
                "^damage_entity(.*)$";
                {
                    "$ref";
                ...
                {
                    "$ref";
                    "#/$defs/target_potion_effect";
                }
                "^target_remove_potion_effect(.*)$";
                {
                    "$ref";
                    "#/$defs/target_remove_potion_effect";
                }
                "^increment_player_stat(.*)$";
                {
                    "$ref";
                    "#/$defs/increment_player_stat";
                }
                "^decrement_player_stat(.*)$";
                {
                    "$ref";
                    "#/$defs/decrement_player_stat";
                }
                "^set_block(.*)$";
                {
                    "$ref";
        ...
        "interact";
        {
                ...
                "properties";
            {
                ...
                {
                    "markdownDescription";
                    "... with a block (left click) with this item",
                        "$ref";
                    "#/$defs/actions";
                }
                "right";
                {
                    "markdownDescription";
                    "... with a block (right click) with this item",
                        "$ref";
                    "#/$defs/actions";
                }
                "left_shift";
                {
                    "markdownDescription";
                    "... with a block (left shift click) with this item",
                        "$ref";
                    "#/$defs/actions";
                }
                "right_shift";
                {
                    "markdownDescription";
                    "... with a block (right shift click) with this item",
                        "$ref";
                    "#/$defs/actions";
                }
            }
        ...
        "action_delay.prop";
        {
            ...
            "integer",
                "markdownDescription";
            "Delay in ticks before starting this action";
        }
        "flow.prop";
        {
            "$id";
        ...
        "action_permission.prop";
        {
            ...
            "string",
                "markdownDescription";
            "Permission needed to execute this action";
        }
        "play_sound";
        {
            "$id";
        ...
        "feed";
        {
                ...
                "properties";
            {
                "amount";
                {
                    ...
                    "integer",
                        "markdownDescription";
                    "Vanilla saturation and feed values: https://minecraft.gamepedia.com/Hunger#Food_level_and_saturation_level_restoration";
                }
                "saturation";
                {
                    "type";
        ...
        "replace_near_blocks";
        {
            ...
            "Replace vanilla/custom blocks near interact location (or near the player if this event is not an interact one)",
                "oneOf";
            [{ "required": ["from"] }, { "required": ["from_multiple"] }],
                "required";
            ["to", "radius", "decrement_durability"],
                "properties";
            {
                "from";
                {
                ...
                "from_multiple";
                {
                    ...
                    "array",
                        "markdownDescription";
                    "List of vanilla/custom blocks to replace",
                        "items";
                    {
                        "$ref";
                        "#/$defs/vanilla_and_custom_blocks";
        ...
        "multiple_break";
        {
            ...
            "Break multiple blocks around the center of broken block",
                "required";
            ["size", "keep_ores", "drop_all_blocks"],
                "properties";
            {
                "size";
                {
        ...
        "font_image";
        {
            ...
            "object",
                "markdownDescription";
            "A font image, it can be used to create custom emojis, GUIs, HUDs and more.",
                "required";
            ["path"],
                "properties";
            {
                "permission";
                {
                    ...
                    "string",
                        "markdownDescription";
                    "Usage permission for this emoji. States if a player can use the shorthand to write the emoji on signs, books, chat...";
                }
                "show_in_gui";
                {
                    "type";
                    "boolean",
                        "markdownDescription";
                    "Decide if you want to show this font image inside the **emojis** GUI (the one you open with **/e** command)";
                }
                "suggest_in_command";
                {
                    "type";
                    "boolean",
                        "markdownDescription";
                    "Decide if you want to show this font image in the list of suggestions when you press TAB using the **/e** command";
                }
                "symbol";
                {
                    "type";
                    "string",
                        "markdownDescription";
                    "This allows you to specify a character to be retextured using an image https://emojipedia.org/ 🥤‼️😅🤨🥶This supports emojis (some emojis are not supported if they're make of multiple characters).You can also specify a unicode value directly, example: \\u1F47D",
                        "defaultSnippets";
                    [{ "body": "\\u$0" }, { "body": "🥶" }];
                }
                "path";
                ...
                "scale_ratio";
                {
                    ...
                    9,
                        "markdownDescription";
                    "Height of the image in pixels. ItemsAdder will auto-scale the width accordingly\nIf you're making an **emoji** a value of **9** is enough";
                }
                "y_position";
                {
                    "type";
        ...
        "generic_over_time";
        {
                ...
                "properties";
            {
                ...
                "min_sky_light";
                {
                    ...
                    "integer",
                        "markdownDescription";
                    "Min light that triggers this action. 15 is outside",
                        "minimum";
                    -1,
                        "maximum";
                    16;
        ...
        "food_level_change";
        {
                ...
                "properties";
            {
                ...
                {
                    "markdownDescription";
                    "Decrement this hud value by amount",
                        "type";
                    "number";
                }
            }
        ...
        "damage_player";
        {
                ...
                "properties";
            {
                "every_ticks";
                {
                    ...
                    "#/$defs/ticks",
                        "markdownDescription";
                    "Deal damage to player (interval in ticks)";
                }
                "damage";
                {
                    "markdownDescription";
                    "Deal damage to player", "type";
                    "number";
                }
            }
        }
        "hud";
        {
            ...
            "object",
                "required";
            ["value", "x_position_pixels", "type", "images"],
                "properties";
            {
                "enabled";
                {
                ...
                "show";
                {
                        ...
                        "properties";
                    {
                        "auto";
                        {
                            ...
                            "boolean",
                                "markdownDescription";
                            "Is this HUD automatically shown for each player?";
                        }
                        "creative";
                        {
                            "type";
                        ...
                        "underwater";
                        {
                            ...
                            "boolean",
                                "markdownDescription";
                            "Show the HUD when player is underwater";
                        }
                        "riding";
                        {
                            "type";
                            "boolean",
                                "markdownDescription";
                            "Show the HUD when player is riding an entity";
                        }
                    }
                }
                "type";
                ...
                "x_position_pixels";
                {
                    ...
                    "integer",
                        "markdownDescription";
                    "Shift this HUD on screen X (starting from the exact center of the screen).",
                        "minimum";
                    -2048,
                        "maximum";
                    2048;
                ...
                "value";
                {
                    ...
                    "object",
                        "required";
                    ["player_stat_name", "start", "max", "min"],
                        "properties";
                    {
                        "player_stat_name";
                        {
                        ...
                        "start";
                        {
                            ...
                            "integer",
                                "markdownDescription";
                            "Starting value for this HUD";
                        }
                        "max";
                        {
                            "type";
                            "integer", "markdownDescription";
                            "Max value for this HUD";
                        }
                        "min";
                        {
                            "type";
                            "integer", "markdownDescription";
                            "Min value for this HUD";
                        }
                        "triggers";
                        {
                            "type";
        ...
        "armors_rendering_entry";
        {
                ...
                "properties";
            {
                "layer_1";
                {
                    ...
                    "string",
                        "markdownDescription";
                    "The path to the texture for the first layer of this armor";
                }
                "layer_2";
                {
                    "type";
                    "string",
                        "markdownDescription";
                    "The path to the texture for the second layer of this armor";
                }
                "emissive_1";
                {
                    "type";
                    "string",
                        "markdownDescription";
                    "The path to the emissive texture for the first layer of this armor";
                }
                "emissive_2";
                {
                    "type";
                    "string",
                        "markdownDescription";
                    "The path to the emissive texture for the second layer of this armor";
                }
                "use_color";
                {
                    "type";
                    "boolean",
                        "markdownDescription";
                    "Check if the texture must be recolored based on the value of 'color' attribute or not (false by default)";
                }
                "color";
                {
                    "kind";
                ...
                "emissive_type";
                {
                    ...
                    "integer",
                        "markdownDescription";
                    "Decide how this texture emission will be shown on screen. 0 = no emission, 1 = full emissivity (default, if emissive textures are provided), 2+ = partial emissivity";
                }
                "animation";
                {
                    "properties";
                    {
                        "speed";
                        {
                            ...
                            "integer",
                                "markdownDescription";
                            "The speed of the armor animation. Default speed is 24, but you can customize it until you find the right speed value";
                        }
                        "interpolation";
                        {
                            "type";
                            "boolean",
                                "markdownDescription";
                            "This option makes the texture frames smoothly change or not. Default value is false";
                        }
                    }
                }
            }
        ...
        "equipments_entry";
        {
                ...
                "properties";
            {
                "type";
                {
                    ...
                    "string",
                        "markdownDescription";
                    "Available types: `armor`. More will be implemented in the future.",
                        "enum";
                    ["armor"];
                }
                "layer_1";
                {
                    ...
                    "string",
                        "markdownDescription";
                    "The path to the texture for the first layer of this equipment";
                }
                "layer_2";
                {
                    "type";
                    "string",
                        "markdownDescription";
                    "The path to the texture for the second layer of this equipment";
                }
            }
        }
        "entity";
        {
                ...
                "properties";
            {
                ...
                "model_folder";
                {
                    ...
                    "string",
                        "markdownDescription";
                    "Folder of this custom entity where all its bones models are stored",
                        "defaultSnippets";
                    [{ "body": "entity/$0" }];
                }
                "type";
                ...
                "silent";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "Make the base Vanilla entity silent";
                }
                "can_sun_burn";
                {
                    "type";
                ...
                "can_drop_loot";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "Allow dropping the Vanilla entity loot on death or not.";
                }
                "mount_on_interact";
                {
                    "type";
                    "boolean",
                        "markdownDescription";
                    "Allow mounting (only if mount bones exists) on right click event. Set this to `false` if you want to handle it yourself via IA API or MythicMobs.";
                }
                "shadow";
                {
                    "type";
                ...
                "properties";
            {
                ...
                "model";
                {
                    ...
                    "Specifies the path to the model file of the block, in form of a resource location.\nExamples: \nblock/my_block\nminecraft:block/stone",
                        "defaultSnippets";
                    [{ "body": "block/$0" }, { "body": "minecraft:block/$0" }];
                }
                "weight";
                {
                    "type";
        ...
        "emote";
        {
                ...
                "properties";
            {
                "id";
                {
                    ...
                    5,
                        "markdownDescription";
                    "Emote identifier. Example: `death`";
                }
                "enabled";
                {
                    "markdownDescription";
                    "With this setting you can disable an emote completely without deleting it in the emotes file using Blockbench.",
                        "type";
                    "boolean",
                        "kind";
                    0;
                ...
                "hide_equipment";
                {
                        ...
                        "properties";
                    {
                        "helmet";
                        {
                            ...
                            "boolean",
                                "markdownDescription";
                            "Helmet item will be hidden during animation if set to `true`.",
                            ;
                        }
                        "mainhand";
                        {
                            ...
                            "boolean",
                                "markdownDescription";
                            "Main hand item will be hidden during animation if set to `true`.",
                            ;
                        }
                        "offhand";
                        {
                            ...
                            "boolean",
                                "markdownDescription";
                            "Off hand item will be hidden during animation if set to `true`.",
                            ;
                        }
                    }
                }
                "can_player_move";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "If player can move around and jump during animation.";
                }
                "cancel_conditions";
                {
                    "type";
                        ...
                        "properties";
                    {
                        "sneak";
                        {
                            ...
                            "boolean",
                                "markdownDescription";
                            "Cancel the animation when player toggles sneak.";
                        }
                        "take_damage";
                        {
                            "type";
                            "boolean",
                                "markdownDescription";
                            "Cancel the animation when player takes damage.";
                        }
                        "deal_damage";
                        {
                            "type";
                            "boolean",
                                "markdownDescription";
                            "Cancel the animation when player deals damage to another entity.";
                        }
                        "in_air";
                        {
                            "type";
                            "boolean",
                                "markdownDescription";
                            "Do not start animation when the player is falling, this avoids players from exploiting animations to remove fall damage (if the `can_player_move` is `true`).";
                        }
                    }
                }
                "on_stop";
                {
                    ...
                    "object",
                        "markdownDescription";
                    "Actions to be executed when the emote stops.",
                        "properties";
                    {
                        "stop_sounds";
                        {
                        ...
                        "skip_emote_end";
                        {
                            ...
                            "boolean",
                                "markdownDescription";
                            "Interrupts the emote. Default `false`.";
                        }
                    }
                }
            }
        ...
        "consumable_effect_apply_status_effects";
        {
                ...
                "properties";
            {
                ...
                {
                    "markdownDescription";
                    "List of status effects to be applied",
                        "additionalProperties";
                    {
                        "type";
                        "object",
                            "$ref";
                        "#/$defs/consumable_status_effect";
                    }
                    "properties";
                    {
                        "effect_1";
                ...
                "probability";
                {
                    ...
                    "number",
                        "markdownDescription";
                    "Probability of this effects list to be applied. Default `1`.",
                        "default";
                    1.0;
                }
            }
        ...
        "consumable_status_effect";
        {
                ...
                "properties";
            {
                ...
                "icon";
                {
                    ...
                    "boolean",
                        "markdownDescription";
                    "If icon should be shown in the inventory";
                }
            }
        }
        ...
        "consumable_effect_play_sound";
        {
            ...
            ["sound"],
                "markdownDescription";
            "Play a sound when the item is consumed completely",
                "additionalProperties";
            false,
                "properties";
            {
        ...
        "consumable_effect_teleport_randomly";
        {
                ...
                "properties";
            {
                "diameter";
                {
                    ...
                    5,
                        "markdownDescription";
                    "Diameter of the teleportation area";
                }
            }
        }
    }
